...
#define ARM64_MMU_L1_BLOCK_SHIFT (ARM64_MMU_L1_BLOCK_ORDER + PAGE_SHIFT)
#define ARM64_MMU_L2_BLOCK_SHIFT (ARM64_MMU_L2_BLOCK_ORDER + PAGE_SHIFT)
#define ARM64_MMU_L3_PAGE_SHIFT  (ARM64_MMU_L3_PAGE_ORDER + PAGE_SHIFT)
...
typedef union {
	struct {
		u64 is_valid : 1, is_table : 1, ignored1 : 10,
